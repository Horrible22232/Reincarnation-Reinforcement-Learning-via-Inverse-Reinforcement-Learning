...
class RecurrentSampler(TrajectorySampler):
    ...
    def forward_model(self, vis_obs, vec_obs, t):
        ...
        policy, value, expert_value, self.recurrent_cell, _ = self.model(vis_obs, vec_obs, memory = self.recurrent_cell, expert_reward_coefficient = self.expert_reward_coefficient)
    ...
    def get_last_value(self):
        ...
        _, last_value, last_expert_value, _, _ = self.model(torch.tensor(self.vis_obs) if self.vis_obs is not None else None,
                                        ...
                                        self.recurrent_cell, expert_reward_coefficient = self.expert_reward_coefficient)
