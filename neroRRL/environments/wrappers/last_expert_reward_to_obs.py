...
class LastExpertRewardToObs(Env):
    """This wrapper adds the last expert reward to the vector observation space of the environment."""
    ...
    def reset(self, reset_params = None):
        ...
        if vec_obs is None:
            ...
            vec_obs = np.concatenate((vec_obs, np.zeros(1)), axis = 0)
