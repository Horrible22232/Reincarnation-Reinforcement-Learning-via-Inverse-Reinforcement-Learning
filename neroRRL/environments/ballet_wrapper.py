...
from neroRRL.environments.ballet.ballet_environment import BalletEnvironment
from neroRRL.environments.ballet.ballet_environment_core import DANCE_SEQUENCES
...
class BalletWrapper(Env):
    ...
    @property
    def image(self):
        """ Returns the image of the current step. (not used)"""
        return None
